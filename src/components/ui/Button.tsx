...
>(
  (
    ...
    const baseStyles = cn(
      ...
      variant === "default" &&
        "bg-gray-500/10 hover:bg-gray-400/15 active:bg-gray-400/15 dark:bg-cyan-500/10 dark:hover:bg-cyan-400/15 dark:active:bg-cyan-400/15 border border-cyan-600 dark:border-cyan-500",
      variant === "transparent" &&
        "bg-transparent hover:bg-gray-400/10 active:bg-gray-400/10 dark:hover:bg-gray-400/10 dark:active:bg-gray-400/10 border border-gray-400/20 dark:border-gray-400/20",
      "rounded-full px-4 transition-all duration-[400ms] ease-out relative",
      "hover:shadow-md active:shadow-md",
      variant === "default" &&
        "hover:shadow-gray-400/20 active:shadow-gray-400/20 dark:hover:shadow-cyan-500/20 dark:active:shadow-cyan-500/20",
      variant === "transparent" &&
        "hover:shadow-gray-400/20 active:shadow-gray-400/20 dark:hover:shadow-gray-400/20 dark:active:shadow-gray-400/20",
      chevron && "pr-12 lg:pr-4 lg:hover:pr-12 lg:active:pr-12 overflow-hidden",
      ...
      <>
        <span
          className={cn(
            ...
            alwaysAnimated
              ...
              : "opacity-0 group-hover:opacity-100 group-active:opacity-100 -translate-x-full group-hover:translate-x-full group-active:translate-x-full"
          )}
          style={
            alwaysAnimated
              ? {
        ...
        {Icon && (
          <span
            className={cn(
              ...
              variant === "default" &&
                "dark:group-hover:text-cyan-400 dark:group-active:text-cyan-400"
            )}
          >
            <Icon
              className={cn(
        ...
        <div
          className={cn(
            ...
            variant === "default" &&
              "dark:group-hover:text-cyan-50 dark:group-active:text-cyan-50"
          )}
        >
          <span>{children}</span>
        </div>
        ...
        {chevron && (
          <span
            className={cn(
              ...
              "lg:group-active:opacity-100 lg:group-active:scale-100 lg:group-active:translate-x-0",
